          ...
          {isLoading ? (
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
              ...
              <div className="lg:col-span-1">
                <div className="bg-white rounded-lg shadow-lg overflow-hidden transform transition-all hover:scale-[1.01] border border-gray-100">
                  <div className="p-6 bg-gradient-to-r from-cyan-500/10 to-brand-orange/10">
                    ...
                    <nav className="space-y-2">
                      ...
                      <Button 
                        variant="ghost" 
                        className="w-full justify-start text-left bg-gray-100 font-medium"
                      >
                        Settings
                      </Button>
                    </nav>
              ...
              <div className="lg:col-span-2 space-y-6">
                {/* Notifications Panel */}
                <div className="bg-white rounded-lg shadow-lg overflow-hidden transform transition-all hover:shadow-xl border border-gray-100">
                  <div className="p-6">
                ...
                {/* Danger Zone Panel */}
                <div className="bg-white rounded-lg shadow-lg overflow-hidden transform transition-all hover:shadow-xl border border-red-100">
                  <div className="p-6">
