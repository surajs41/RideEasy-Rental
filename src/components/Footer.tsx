    ...
    <footer className="bg-brand-blue text-white py-8 mt-12">
      <div className="container mx-auto px-4">
        <div className="flex flex-col items-center mb-6">
          <img src="/images/bikes/RideEasy.png" alt="RideEasy Logo" className="h-20 mb-2" style={{ maxWidth: '300px' }} />
        </div>
        <div className="container mx-auto grid grid-cols-1 md:grid-cols-4 gap-8 px-4">
          {/* Company Info */}
          <div>
            <h3 className="text-xl font-bold mb-4">RideEasy</h3>
            <p className="text-gray-300 mb-4">
              Your trusted partner for hassle-free bike rentals. Experience the freedom of riding with RideEasy.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link to="/bikes" className="text-gray-300 hover:text-white transition-colors">Bikes</Link></li>
        ...
        <div className="mt-8 pt-8 border-t border-gray-700 text-center">
          <p className="text-gray-300">© {new Date().getFullYear()} RideEasy. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
